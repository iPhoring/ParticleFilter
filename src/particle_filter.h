...
struct Particle {
  ...
  double x;
  double y;
  std::vector<Observation> transformedObs; //holding transformed observation coordinates for the particle
  std::vector<LandmarkObs> predictionObs; //holding lanmarks within sensor range of the particle(not all landmarks)
  double theta;
  double weight;
